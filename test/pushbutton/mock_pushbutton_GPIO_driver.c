...
enum button_state_e PUSHBUTTON_1_STATE=UNKNOWN;
enum button_state_e PUSHBUTTON_2_STATE=UNKNOWN;

uint8_t TEST_TIMER=0;

static void pushbutton_1_gpio_init(void);
static void pushbutton_2_gpio_init(void);
static enum button_state_e get_pushbutton_1_state(void);
static enum button_state_e get_pushbutton_2_state(void);
