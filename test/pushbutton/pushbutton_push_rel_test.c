...
static void ckeck_button_state_5_times(pushbutton_name_t button_name);
...
static void generate_pin_bounce_on_push(pushbutton_name_t button_name)
{
    ...
    ckeck_button_state_5_times(button_name);
...
static void ckeck_button_state_5_times(pushbutton_name_t button_name)
{
    check_button_short_push_long_push(button_name);
    check_button_short_push_long_push(button_name);
    check_button_short_push_long_push(button_name);
    check_button_short_push_long_push(button_name);
}
